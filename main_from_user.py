...
# Take a point as user input - exact approach not confirmed
# input = None
# points = []
# while input.lower() != "q":
#   points.append(input("Please enter a comma separated point pair, else enter \'q\' to quit: ")
#   add some validation

# Categorise point as inside, outside or boundary
